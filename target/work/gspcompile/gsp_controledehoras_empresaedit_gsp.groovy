...
class gsp_controledehoras_empresaedit_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'empresa.label', default: 'Empresa'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',21,['bean':(empresaInstance),'var':("error")],3)
printHtmlPart(15)
})
invokeTag('hasErrors','g',23,['bean':(empresaInstance)],2)
printHtmlPart(8)
createTagBody(2, {->
printHtmlPart(16)
invokeTag('hiddenField','g',25,['name':("version"),'value':(empresaInstance?.version)],-1)
printHtmlPart(17)
...
invokeTag('uploadForm','g',32,['url':([resource:empresaInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1408029035000L
